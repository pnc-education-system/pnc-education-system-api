...
<head>
    ...
    <style>
        ...
        .summary-table td { border: 1px solid #e2e8f0; text-align: center; font-size: 10px; }
        .summary-table td:first-child { font-weight: 700; background-color: #f8fafc; }
...
<body>
    ...
    <p class="subtitle">Generated on: {{ now()->format('F j, Y H:i:s') }}</p>

    <table class="summary-table" width="60%" cellpadding="4" cellspacing="0">
        <tr>
    ...
    <div class="footer">Passerellesnumeriques Cambodia — Enrollment Report</div>
</body>
</html>
