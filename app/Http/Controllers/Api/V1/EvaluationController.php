...
class EvaluationController extends Controller
{
    ...
    /**
     * Reusable eager-loading scope for templates with ordered categories and questions.
     */
    private function withCategoriesAndQuestions(): array
    {
        return ['categories' => function ($query) {
    ...
    {
        $templates = EvaluationForm::with($this->withCategoriesAndQuestions())
            ->orderBy('name')
            ->get();
    ...
    {
        $template = EvaluationForm::with($this->withCategoriesAndQuestions())->find($id);
    ...
    public function storeTemplate(Request $request): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => new EvaluationTemplateResource($template->load($this->withCategoriesAndQuestions())),
        ], 201);
    }
    ...
    public function storeCategory(Request $request, int $templateId): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => new \App\Http\Resources\EvaluationCategoryResource($category),
        ], 201);
    }
    ...
    public function storeQuestion(Request $request, int $categoryId): JsonResponse
    {
        ...
        return response()->json([
            ...
            'data'    => new \App\Http\Resources\EvaluationQuestionResource($question),
        ], 201);
    }
